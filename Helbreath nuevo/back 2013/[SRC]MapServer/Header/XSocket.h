...
#define DEF_XSOCKEVENT_HALFCLOSE              -137    // cierre parcial: el socket sigue vivo pero no hay datos
...
public:	
	...
	bool m_limbo;
	bool _CompressData(const char* pInput, DWORD dwInputSize, char* pOutput, DWORD& dwOutputSize);
	bool _UncompressData(const char* pInput, DWORD dwInputSize, char* pOutput, DWORD& dwOutputSize);
	void _CloseConn();
	SOCKET m_Sock;
private:
