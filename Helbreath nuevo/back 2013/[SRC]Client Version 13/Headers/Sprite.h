...
public:
	...
	void PutSpriteFastClip(int sX, int sY, int srcX, int srcY, int srcW, int srcH, DWORD dwTime);
	...
	void PutSpriteFastNoColorKeyDstGrayscale(LPDIRECTDRAWSURFACE7 lpDstS, int sX, int sY, int sFrame, DWORD dwTime);
	void PutSpriteFastNoColorKeyDstGammaBoost(LPDIRECTDRAWSURFACE7 lpDstS, int sX, int sY, int sFrame, DWORD dwTime, float fGammaBoost);
	void PutSolidColorTransSprite(int sX, int sY, int sFrame, const ColorRGB& color, int alphaPercent, DWORD dwTime);
	void PutFuegoScrollEffect(int sX, int sY, int sFrame, const ColorRGB& color, int alphaPercent, int offset, DWORD dwTime);
	void PutTintedSpriteRGB(int sX, int sY, int sFrame, int sRed, int sGreen, int sBlue, DWORD dwTime);
	void PutTransSpriteScaled(int sX, int sY, int sFrame, DWORD dwTime, int alphaDepth = 30);
	void PutTransSpriteMiniScaled(int sX, int sY, int sFrame, DWORD dwTime, int alphaDepth = 30);
	void PutTransSpriteMoreMiniScaled(int sX, int sY, int sFrame, DWORD dwTime, int alphaDepth = 30);
	...
	void DrawSimpleSmoke(int dX, int dY, int szx, int szy, DWORD dwTime);
	void PutTransSpriteRGBWithFire(int sX, int sY, int sFrame, int sRed, int sGreen, int sBlue, DWORD dwTime);
	...
	void PutAlphaSprite(int sX, int sY, int sFrame, DWORD dwTime, int alphaLevel);
	...
	void PutTransSprite2MiniScaled(int sX, int sY, int sFrame, DWORD dwTime);
	void PutSpriteRGBMiniScaled(int sX, int sY, int sFrame, int sRed, int sGreen, int sBlue, DWORD dwTime);
	void PutSpriteFastMiniScaled(int sX, int sY, int sFrame, DWORD dwTime);
	void PutSpriteFastNoColorKeyMiniScaled(int sX, int sY, int sFrame, DWORD dwTime);
};
